...
class GrupoSenaViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ["nombre__nombre"]   # Solo buscará por el nombre del grupo
    ordering_fields = ["fecha_creacion", "fecha_cierre", "capacidad"]
...
def editar_grupo(request, id):
    ...
    if request.method == "POST":
        ...
        grupo.lider_id = int(lider_id) if lider_id else None
        grupo.observacion = observacion or grupo.observacion
        grupo.fecha_cierre = fecha_cierre or None
